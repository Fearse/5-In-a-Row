...
REM
REM Generated by Vivado on Wed Nov 30 14:50:14 +0300 2022
...
echo "xvlog --incr --relax -prj testFSm_vlog.prj"
call xvlog  --incr --relax -prj testFSm_vlog.prj -log xvlog.log
